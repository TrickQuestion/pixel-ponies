...
public class UncommonCodex extends Codex {

	public UncommonCodex(){
		image     = ItemSpriteSheet.UNCOMMON_CODEX;
		idTag	  = "uncommon-codex-id";

		//TODO Need rework this. Transifex just hates string-arrays
		maxId     = Game.getVars(R.array.UncommonCodex_Titles).length;
		id        = Random.Int(maxId);
		name	  = Game.getVars(R.array.UncommonCodex_Titles)[id];
	}
	...
	public void execute( Hero hero, String action ) {
		if (action.equals( AC_READ )) {
			...
			WndStory.showCustomStory(Game.getVars(R.array.UncommonCodex_Stories)[id]);
		} else {
