...
public class CommonCodex extends Codex {

	public CommonCodex(){
		image     = ItemSpriteSheet.COMMON_CODEX;
		idTag	  = "common-codex-id";

		//TODO Need rework this. Transifex just hates string-arrays
		maxId     = Game.getVars(R.array.CommonCodex_Titles).length;
		id        = Random.Int(maxId);
		name	  = Game.getVars(R.array.CommonCodex_Titles)[id];
	}
	...
	public void execute( Hero hero, String action ) {
		if (action.equals( AC_READ )) {
			...
			WndStory.showCustomStory(Game.getVars(R.array.CommonCodex_Stories)[id]);
		} else {
