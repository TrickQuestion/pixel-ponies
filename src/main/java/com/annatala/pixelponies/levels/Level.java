...
import com.annatala.pixelponies.actors.blobs.WellWater;
...
import com.annatala.pixelponies.actors.buffs.Shadows;
...
import com.annatala.pixelponies.effects.particles.WindParticle;
...
import com.annatala.pixelponies.levels.traps.AlarmTrap;
import com.annatala.pixelponies.levels.traps.FireTrap;
import com.annatala.pixelponies.levels.traps.GrippingTrap;
import com.annatala.pixelponies.levels.traps.LightningTrap;
import com.annatala.pixelponies.levels.traps.ParalyticTrap;
import com.annatala.pixelponies.levels.traps.PoisonTrap;
import com.annatala.pixelponies.levels.traps.SummoningTrap;
import com.annatala.pixelponies.levels.traps.ToxicTrap;
import com.annatala.pixelponies.mechanics.ShadowCaster;
...
public abstract class Level implements Bundlable {
	...
	public void create(int w, int h) {
		...
		if (!isBossLevel()) {
			...
			if (Dungeon.pohNeeded()) {
				addItemToSpawn(new PotionOfHonesty());
				Dungeon.potionsOfHonesty++;
			}
			if (Dungeon.soloNeeded()) {
