...
public class HeroSprite extends CharSprite {
    ...
    public static TextureFilm tiers() {
        if (tiers == null) {
            SmartTexture texture = TextureCache.get( Assets.EARTH );
    ...
    public static CompositeTextureImage avatar(HeroClass cl, int armorTier ) {

        RectF patch = tiers().get( armorTier );
        CompositeTextureImage avatar = new CompositeTextureImage( cl.spritesheet() );
