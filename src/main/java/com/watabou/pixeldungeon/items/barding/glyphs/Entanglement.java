 ...
 */
package com.watabou.pixeldungeon.items.barding.glyphs;
...
import com.watabou.pixeldungeon.items.barding.Barding.Glyph;
...
public class Entanglement extends Glyph {
	...
	@Override
	public int proc(com.watabou.pixeldungeon.items.barding.Barding barding, Char attacker, Char defender, int damage ) {
